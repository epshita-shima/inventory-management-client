...
import GRNInfoList from "./GRNInformationTable/GRNInfoList";
...
const GRNInfoTable = () => {
  ...
  return (
    <div>
      <GRNInfoList permission={permission} click={clickhandler} />
